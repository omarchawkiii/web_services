...
<div class="flex h-full">
    ...
    <aside class="flex w-64 flex-col bg-slate-900">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4">
            ...
            <a href="{{ route('admin.hub-unified-errors.index') }}"
               class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors
                      {{ request()->routeIs('admin.hub-unified-errors.*') ? 'bg-slate-700 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
